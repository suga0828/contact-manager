    ...
    <nav className="flex items-center justify-between flex-wrap bg-teal-500 p-6">
      ...
      <ul className={`${opened ? 'block' : 'hidden'} w-full md:flex md:items-center md:w-auto mt-4 border-t md:mt-0 md:border-t-0`}>
        <li className="px-4 py-2">
          <Link to="/" className="text-sm leading-none text-teal-200 border-white hover:text-white mt-4 lg:mt-0">Home</Link>
        </li>
        <li className="px-4 py-2">
          <Link to="/about" className="text-sm leading-none text-teal-200 border-white hover:text-white mt-4 lg:mt-0">About us</Link>
        </li>
        <li className="px-4 py-2">
          <Link to="/contact/add" className="text-sm leading-none text-teal-200 border-white hover:text-white mt-4 lg:mt-0">Add contact</Link>
        </li>
      </ul>
    </nav>
  );
