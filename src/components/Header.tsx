  ...
  return (
    <nav className="flex items-center justify-between flex-wrap bg-teal-500 p-6">
      ...
      <div className="block md:hidden">
        <button onClick={() => toggleMenu(!opened)} className="flex items-center px-3 py-2 border rounded text-teal-200 border-teal-400 hover:text-white hover:border-white">
